...
import com.yxnne.mysides.gif.AnimatedGifDrawable;
import com.yxnne.mysides.gif.AnimatedImageSpan;
            ...
            public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
                try {
                    ...
                    if (!png.contains("_del")) {// 如果不是删除图标
                        ChatFaceUtil.insert(editText, ChatFaceUtil.getFace(context,png));
                    } else {
                        ChatFaceUtil.delete(editText);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
